...
public class Game {
	...
	public void test() throws SQLException {
		...
		dao.getGuerrier(); // affichage la liste des guerriers
		dao.getMagicien(); // affiche la liste des magiciens
		//dao.createPersonnage(); // méthode de création de personnage
		
		dao.supprimerPersonnage(12); //supprime le personnage dans la BDD avec l'index 10 - OK
