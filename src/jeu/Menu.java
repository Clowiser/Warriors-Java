...
public class Menu {
	...
	public void lancerDes() {
		...
		do {
			...
			position += resultatDe; // additionne les deux var et stocke le résultat dans var gauche
	...
	// résultat de l'avancé du joueur sur le plateau -> placement sur plateau // ici
